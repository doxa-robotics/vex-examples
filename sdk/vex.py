...
VelocityPercentUnits = Union[VelocityUnits.VelocityUnits,
                             PercentUnits.PercentUnits]
TorquePercentUnits = Union[TorqueUnits.TorqueUnits, PercentUnits.PercentUnits]
TorquePercentCurrentUnits = Union[TorqueUnits.TorqueUnits,
                                  PercentUnits.PercentUnits, CurrentUnits.CurrentUnits]
TemperaturePercentUnits = Union[TemperatureUnits.TemperatureUnits,
                                PercentUnits.PercentUnits]
AnalogPercentUnits = Union[AnalogUnits.AnalogUnits, PercentUnits.PercentUnits]
RotationPercentUnits = Union[RotationUnits.RotationUnits,
                             PercentUnits.PercentUnits]
